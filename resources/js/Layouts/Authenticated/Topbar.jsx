            ...
            <div className="flex items-center gap-4">
                ...
                <div className="collapsible-dropdown flex flex-col gap-2 relative">
                    <a href="#!"
                        ...
                        <img src="/images/avatar.png" className="rounded-full object-cover w-full" alt="" onClick={triggerDropdown}/>
                    </a>
                    <div className="bg-white rounded-2xl text-black font-medium flex flex-col gap-1 absolute z-[999] right-0 top-[80px] min-w-[180px] hidden overflow-hidden" ref={dropdownTarget}>
                        ...
                        <Link href={route('logout')} method="post" as="button" className="transition-all hover:bg-sky-100 p-4 text-start">Sign Out</Link>
                    </div>
                </div>
            </div>
            <style jsx="true">
